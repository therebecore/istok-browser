 ...
 * Где именно лежит описание - подробность одного адреса: сегодня это закрытый gist,
 * после открытия исходников будет страница релиза на GitHub, и переезд сведётся
...
internal object Updates {
    ...
    /**
     * Адрес описания последней сборки. Единственное место, которое меняется при переезде
     * с gist на страницу релиза - формат описания остаётся тем же.
     */
    private const val MANIFEST_URL =
        "https://gist.githubusercontent.com/therebecore/5f4e9660740c1af462d6a16905096d37/raw/istok-update.json"
